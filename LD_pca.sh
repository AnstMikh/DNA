...
srun plink --bfile data --indep-pairwise 50 10 .5 --chr 1-22 --geno 0.98 --out ~/plink/light_data
srun plink --bfile data --allow-extra-chr --extract ~/plink/light_data.prune.in --make-bed --out light_data
